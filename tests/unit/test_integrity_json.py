...
@pytest.mark.parametrize("invalid_input, expected_msg", [
    ...
    ({**VALID_LOGICS, "contract_name": ""}, "CONTRACT_NAME_EMPTY"),
    ({**VALID_LOGICS, "variables": []}, "VARIABLES_EMPTY"),
])
...
@pytest.mark.parametrize("list_key, patch, expected_msg", [
    ...
    ("variables", {"definition": None}, "DEFINITION_MISSING"),
    ("variables", {"definition": True}, "DEFINITION_NOT_STR"),
    ("variables", {"definition": ""}, "DEFINITION_EMPTY"),
    ...
    ("logical_conditions", {"formula": None}, "FORMULA_MISSING"),
    ("logical_conditions", {"formula": False}, "FORMULA_NOT_STR"),
    ("logical_conditions", {"formula": ""}, "FORMULA_EMPTY"),
    ("logical_conditions", {"evidence": None}, "EVIDENCE_MISSING"),
    ("logical_conditions", {"evidence": 1.1}, "EVIDENCE_NOT_STR"),
    ("logical_conditions", {"evidence": ""}, "EVIDENCE_EMPTY"),
    ("logical_conditions", {"evidence_page": None}, "EVIDENCE_PAGE_MISSING"),
    ("logical_conditions", {"evidence_page": "45"}, "EVIDENCE_PAGE_NOT_INT"),
    ("logical_conditions", {"evidence_page": -1}, "EVIDENCE_PAGE_BELOW_ONE"),
])
